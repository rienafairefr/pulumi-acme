...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		P:    p,
		Name: "acme",
		Description: "A Pulumi provider for managing and generating certificates" +
			"generated by an ACME CA, such as Let's Encrypt.",
		Keywords:   []string{"pulumi", "acme"},
		License:    "Apache-2.0",
		...
		Config: map[string]*tfbridge.SchemaInfo{
			...
			"server_url": {
				Default: &tfbridge.DefaultInfo{
					EnvVars: []string{"ACME_SERVER_URL"},
				},
			},
		},
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			// resourceMap for terraform provider
			// https://github.com/vancluever/terraform-provider-acme/blob/master/acme/provider.go

			"acme_registration": {
				Tok: makeResource(mainMod, "Registration"),
				Docs: &tfbridge.DocInfo{
					Source: "registration.html.markdown",
				},
			},
